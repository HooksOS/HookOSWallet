...
const Routes = {
  ...
  HOOKOS_ARENA_SCREEN: 'HookosArenaScreen',
  HOOKOS_BATTLE_DETAIL_SHEET: 'HookosBattleDetailSheet',
  HOOKOS_BATTLE_PASS_SHEET: 'HookosBattlePassSheet',
  HOOKOS_BRIDGE_SHEET: 'HookosBridgeSheet',
  HOOKOS_CLAN_DETAIL_SHEET: 'HookosClanDetailSheet',
  HOOKOS_CLANS_SCREEN: 'HookosClansScreen',
  HOOKOS_EVENT_DETAIL_SHEET: 'HookosEventDetailSheet',
  HOOKOS_EVENTS_SCREEN: 'HookosEventsScreen',
  HOOKOS_FEES_SCREEN: 'HookosFeesScreen',
  HOOKOS_HOOK_DETAIL_SHEET: 'HookosHookDetailSheet',
  HOOKOS_HOOKS_SCREEN: 'HookosHooksScreen',
  HOOKOS_LAUNCH_ENTRY_DETAIL_SHEET: 'HookosLaunchEntryDetailSheet',
  HOOKOS_LAUNCH_WARS_SCREEN: 'HookosLaunchWarsScreen',
  HOOKOS_LICENSE_DETAIL_SHEET: 'HookosLicenseDetailSheet',
  HOOKOS_LICENSES_SCREEN: 'HookosLicensesScreen',
  HOOKOS_NFT_SHEET: 'HookosNftSheet',
  HOOKOS_QUEST_DETAIL_SHEET: 'HookosQuestDetailSheet',
  HOOKOS_QUESTS_SCREEN: 'HookosQuestsScreen',
  HOOKOS_REPUTATION_SHEET: 'HookosReputationSheet',
  HOOKOS_STAKING_SHEET: 'HookosStakingSheet',
  HOOKOS_TOKEN_DETAIL_SHEET: 'HookosTokenDetailSheet',
  HOOKOS_TOKENS_SCREEN: 'HookosTokensScreen',
